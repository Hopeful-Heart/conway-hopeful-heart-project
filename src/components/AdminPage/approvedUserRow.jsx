        ...
        <>
            <TableRow key={user.id}>
                ...
                <TableCell align="center">
                    <Tooltip title="This will freeze the user's account, not allowing them to access the application.">
                        <Button
                            variant="contained"
                            color="primary"
                            onClick={() => updateApproved(user)}
                            style={{ margin: 2.5 }}
                        >
                            Freeze
                        </Button>
                    </Tooltip>
                    <Tooltip title="This will remove the user's account forever!">
                        <Button
                            variant="contained"
                            color="primary"
                ...
                {!superAdmin ? (
                    ...
                    <TableCell align="center">
                        <Tooltip title="This will give a user admin level access.">
                            <Button
                                variant="contained"
                                color="primary"
                                onClick={() => updateNonAdminUser(user)}
                            >
                                Admin
                            </Button>
                        </Tooltip>
                    ...
                    <TableCell align="center">
                        <Tooltip title="This will remove a user's admin level access.">
                            <Button
                                variant="contained"
                                color="primary"
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Are You Sure You want to delete this user? They will be lost
                        forever!
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    ...
                    <Button
                        onClick={() => deleteApprovedUser(deleteUser)}
                        color="primary"
                        autoFocus
                    >
                        Delete
